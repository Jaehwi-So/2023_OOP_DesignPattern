...
public class Main {
    String[] names = { "CompareModifiedDate", "CompareFileType", "CompareFileName", "j09_adapter_facade.j12_composite_pattern.Main", "CompareSize"  };
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\n파일 이름으로 정렬된 리스트");
        sorter.bubbleSort(fileLists);   //절대 건들지 말 것
        m.printFileLists(fileLists);
